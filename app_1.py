...
# #option page
st.markdown("<h1 style='color:orange;font-family:Pacifico;font-size:50px;text-align: center;'>Cat Breed Classifier</h1>", unsafe_allow_html=True)
st.write("")
